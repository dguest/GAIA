...
static PyObject* ntup_from_d3pd(PyObject *self, PyObject *args)
{
    ...
    bool ok = PyArg_ParseTuple (args,"Osss|Os:ctuple_maker", &py_input_files, &input_tree, &jet_collection, &output_file, &floats_dict, &flags); 
    if (!ok)
    {
        return NULL;
    }
